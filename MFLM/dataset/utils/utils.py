...
IML_TAMPER_QUESTION_LIST = [
    "Does this image exhibit any signs of being altered from its original state captured by a camera?",
    "Could you point out any regions in this photo that give the impression of artificial modification?",
    "Are there any discrepancies in this image that would suggest it's not a direct output from a camera?",
    "Can you identify any specific areas in the photograph that seem to have been manipulated?",
    "What are the tell-tale signs in this image that indicate it might have undergone digital tampering?",
    "Could you specify which parts of this image appear to be doctored and not authentic?",
    "Are there elements within this image that betray signs of post-capture editing?",
    "Can you discern any aspects of this photo that don't seem to align with a natural camera shot?",
    "What sections of this image raise suspicions about potential digital interference?",
    "Is there evidence within this picture that suggests it was modified using image editing software?",
    "Can you pinpoint anomalies in the image that would typically arise from tampering?",
    "Are there any inconsistencies in the image that would not be present in a direct camera capture?",
    "Could you highlight which features of this image appear to be fabricated or artificially inserted?",
    "What parts of this image seem to deviate from the expected characteristics of an untouched photograph?",
    "Can you detect any specific alterations that would not naturally occur in a camera-taken image?",
    "Are there any indications of unnatural manipulations within this photo's composition?",
    "What areas of this image give the impression of having been retouched or modified post-capture?",
    "Can you locate any portion of this image that exhibits signs of being digitally altered?",
    "Are there any visual clues in this image that point to it being edited or tampered with after being taken?",
    "Could you outline the irregularities that suggest this image might not be a direct photograph from a camera?",
]


LONG_QUESTION_LIST = [
    "\n" + "This is a tampered image, point out the areas you believe have been tampered with. Please respond with segmentation mask.",
    "\n" + "This is a tampered image, point out the areas you believe have been tampered with. Please output segmentation mask.",
]